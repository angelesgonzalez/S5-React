...
function handleClick() {
	console.log("clicked from the mobile menu");
}
...
export const MobileMenu = () => {
	return (
		<>
			<div
				className="mobile-menu__nav overflow-hidden is-hidden"
				...
				<nav className="mobile-menu__nav">
					<NavLinks className="mobile-menu__list" />
					<Button variant="outlined" onClick={handleClick}>
						LOGIN
					</Button>
				</nav>

				{/* esto puede ser un componente mas pequeno, los iconos hay que hacerlos  */}

				<div className="mobile-menu__social-container">
					<a
						href="#"
